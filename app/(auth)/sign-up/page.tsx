...
const SignUpForm: React.FC = () => {
  ...
  const handleSignUp = async () => {
    ...
    if (!validatePassword(password))
      return setErrorMessage("password should be atleast 8.");
    if (password !== confirmPassword)
      return setErrorMessage("Password confirmation not correct.");
    setErrorMessage("");
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-blue-50 py-6">
      <div className="bg-white shadow-md rounded-lg p-8 max-w-md w-full mx-4">
        ...
        <h2 className="text-xl mb-12 text-center font-bold">
          Create an Account
        </h2>
        <form onSubmit={onSubmit}>
          ...
          {succesfull && (
            <div className="text-green-500 text-center texx-sm">
              {succesfull}
            </div>
          )}
          {errorMessage && (
