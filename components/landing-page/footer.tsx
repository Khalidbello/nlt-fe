            ...
            <div className="flex justify-evenly flex-wrap gap-10 mb-6">
                <div className="flex flex-col max-w-[16rem] gap-3">
                    ...
                    <p className="bg-gray-900 p-4 rounded-xl">
                        ...
                        all on your schedule and from the comfort of your phone. Take control, leverage your lifestyle, and live the life you deserve with Lifestyle Leverage.
                    </p>
                </div>
                <div>
                    ...
                    <ul className="">
                        <li>
                            <ScrollLink
                                ...
                                className={`${activeSection === 'features' ? 'text-blue-700' : ' text-white'} mb-2 before:content-['•'] before:mr-2 before:text-2xl before:text-blue-700`}
                            >
                                features
                            </ScrollLink>
                        </li>
                        <li>
                            <ScrollLink
                                ...
                                className={`${activeSection === 'review' ? 'text-blue-700' : ' text-white'} mb-2 before:content-['•'] before:mr-2 before:text-2xl before:text-blue-700`}
                            >
                                Reviews
                            </ScrollLink>
                        </li>
                        <li>
                            <ScrollLink
                                ...
                                className={`${activeSection === 'news-letter' ? 'text-blue-700' : ' text-white'} mb-2 before:content-['•'] before:mr-2 before:text-2xl before:text-blue-700`}
                            >
                                News Letter
                            </ScrollLink>
                        </li>
                        <li>
                            <Link href='/sign-in' className="mb-2 text-white before:content-['•'] before:mr-2 before:text-2xl before:text-blue-700">Sign in</Link>
                        </li>
                        <li>
                            <Link href='/sign-up' className="mb-2 text-white before:content-['•'] before:mr-2 before:text-2xl before:text-blue-700">Sign up</Link>
                        </li>
                    </ul>
                </div>
                <div>
