...
export default function Hero() {
    ...
    return (
        <div className="bg-blue-700 pt-10 max-w-srcree-2xl h-auto flex flex-col justify-around items-center  gap-x-10 gap-y-14 px-10  md:h-full  md:flex-row md:px-20">
            <div className="flex flex-col items-start gap-y-6 mr-8 text-center md:text-left">
                <p className="pt-28 text-3xl md:text-5xl font-bold md:font-extrabold text-white flex flex-col gap-y-12 items-start">
                    <span>{`You've Got a Business Problem`}<span className="text-blue-500">... </span>?</span>
                    <span>{`We've Got the Tech Solution`}<span className="text-blue-500">....</span></span>
                </p>
                <p className="text-white flex-grow-1 text-center md:text-left">
                    Attain <span className='text-blue-200'>life changing</span> skills with ease
                </p>
