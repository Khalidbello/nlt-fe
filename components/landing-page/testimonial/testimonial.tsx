...
export default function StudentsReview() {
  ...
  if (fetching) {
    return (
      <div
        id="review"
        className="bg-gray-200 px-4 md:px-10 py-20 md:p-10 relative"
      >
  ...
  return (
    <div
      id="review"
      className="bg-gray-200 px-4 md:px-10 py-20 md:p-10 relative mb-8"
    >
      <h2 className="flex flex-col items-center justify-center gap-2 text-center mb-3">
      ...
      <div className="md:max-w-[1100px] relative mx-auto">
        ...
        <button
          className="left-bt absolute top-[50%] left-[-10px] md:left-0 z-10 bg-blue-800 bg-opacity-50 p-2 w-14 h-14 rounded-full flex justify-center items-center"
          onClick={leftScroll}
        >
          <FontAwesomeIcon
            icon={faLessThan}
        ...
        <button
          className="right-bt absolute top-[50%] right-[-10px] md:right-0 z-10 bg-blue-800 bg-opacity-50 p-2 w-14 h-14 rounded-full flex justify-center items-center"
          onClick={rightScroll}
        >
          <FontAwesomeIcon
            icon={faGreaterThan}
      ...
      <div className="indcator flex justify-center items-center gap-1 mt-4">
        {reviews.map((_: any, index: any) => (
          <button
            key={index}
            className={`hover:bg-orange-100 w-2 h-2 rounded-full ${
              index === current ? "bg-orange-300" : "bg-gray-100"
            }`}
